      ...
      <a href='https://en.wikipedia.org/wiki/Roman_Empire' target='blank'>
        <div>
          <div className='flex items-center justify-center'>
            <img src={rome26} alt='rome26' style={{width: '240px', borderRadius: '30px'}} />
          </div>
          <h3 className='text-xl font-bold py-4'>"Roman Empire (27 BC - AD 1453)"</h3>
          <p className='flex items-center lg:h-[80%] pb-12 lg:pb-0'>
                "The Roman Empire is generally understood to mean the period and territory 
