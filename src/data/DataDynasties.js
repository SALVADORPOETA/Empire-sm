...
export const dataDynasties = [
    {
        id: "1",
        link: "https://en.wikipedia.org/wiki/Julio-Claudian_dynasty",
        image: rome1,
        heading: "Julio-Claudian dynasty (27 BC – AD 68)",
        text: "The Julio-Claudian dynasty comprised the first five Roman emperors: Augustus, Tiberius, Caligula, Claudius, and Nero. This line of emperors ruled the Roman Empire, from its formation (under Augustus, in 27 BC) until the last of the line, Emperor Nero, committed suicide (in AD 68). The name Julio-Claudian is a historiographical term, deriving from the two families composing the imperial dynasty: the Julii Caesares and Claudii Nerones.",
    },
    {
        id: "2",
        ...
        text: "The Year of the Four Emperors, AD 69, was the first civil war of the Roman Empire, during which four emperors ruled in succession: Galba, Otho, Vitellius, and Vespasian. It is considered an important interval, marking the transition from the Julio-Claudians, the first imperial dynasty, to the Flavian dynasty. The period witnessed several rebellions and claimants, with shifting allegiances and widespread turmoil in Rome and the provinces.",
    },
    {
        id: "3",
    ...
    },
    {
        ...
        text: "The Nerva–Antonine dynasty comprised seven Roman emperors who ruled from AD 96 to 192: Nerva (96–98), Trajan (98–117), Hadrian (117–138), Antoninus Pius (138–161), Marcus Aurelius (161–180), Lucius Verus (161–169), and Commodus (177–192). The first five of these are commonly known as the 'Five Good Emperors'.",
    },
    {
        id: "5",
        ...
        text: "The Year of the Five Emperors was AD 193, in which five men claimed the title of Roman emperor: Pertinax, Didius Julianus, Pescennius Niger, Clodius Albinus, and Septimius Severus. This year started a period of civil war when multiple rulers vied for the chance to become emperor.",
    },
    {
        id: "6",
        ...
        text: "The Severan dynasty, sometimes called the Septimian dynasty, was an Ancient Roman imperial dynasty that ruled the Roman Empire between 193 and 235, during the Roman imperial period. The dynasty was founded by the emperor Septimius Severus (r. 193–211), who rose to power after the Year of the Five Emperors as the victor of the civil war of 193–197, and his wife, Julia Domna.",
    },
    {
        id: "7",
    ...
    },
    {
        ...
        text: "The Tetrarchy was the system instituted by Roman emperor Diocletian in 293 AD to govern the ancient Roman Empire by dividing it between two emperors, the augusti, and their junior colleagues and designated successors, the caesares.",
    },
    {
        id: "9",
        ...
        text: "The Constantinian dynasty is an informal name for the ruling family of the Roman Empire from Constantius Chlorus (died 306) to the death of Julian in 363. It is named after its most famous member, Constantine the Great, who became the sole ruler of the empire in 324. The dynasty is also called Neo-Flavian because every Constantinian emperor bore the name Flavius, similarly to the rulers of the first Flavian dynasty in the 1st century.",
    },
    {
        id: "10",
    ...
    },
    {
        ...
        text: "The fall of the Western Roman Empire, also called the fall of the Roman Empire or the fall of Rome, was the loss of central political control in the Western Roman Empire, a process in which the Empire failed to enforce its rule, and its vast territory was divided between several successor polities.",
    },
    {
        id: "13",
    ...
    },
    {
        ...
        text: "The Byzantine Empire under the Nikephorian dynasty began following the deposition of the Byzantine empress Irene of Athens, the throne of the Byzantine Empire passed to a relatively short-lived dynasty, the Nikephorian dynasty, named after its founder, Nikephoros I. The empire was in a weaker and more precarious position than it had been for a long time and its finances were problematic.",
    },
    {
        id: "19",
        ...
        text: "The Byzantine Empire under the Amorian dynasty (or Phrygian dynasty) ruled from 820 to 867. The Amorian dynasty continued the policy of restored iconoclasm (the 'Second Iconoclasm') started by the previous non-dynastic emperor Leo V in 813, until its abolition by Empress Theodora with the help of Patriarch Methodios in 842. The continued iconoclasm further worsened relations between the East and the West, which were already bad following the papal coronations of a rival line of 'Roman Emperors' beginning with Charlemagne in 800. Relations worsened even further during the so-called Photian Schism, when Pope Nicholas I challenged Photios' elevation to the patriarchate.",
    },
    {
        id: "20",
        ...
        text: "The Macedonian dynasty (Greek: Μακεδονική Δυναστεία) ruled the Byzantine Empire from 867 to 1056, following the Amorian dynasty. During this period, the Byzantine state reached its greatest extent since the Early Muslim conquests, and the Macedonian Renaissance in letters and arts began. The dynasty was named after its founder, Basil I the Macedonian who came from the theme of Macedonia.",
    },
    {
        id: "21",
        ...
        text: "The House of Doukas, was a Byzantine Greek noble family, whose branches provided several notable generals and rulers to the Byzantine Empire in the 9th–11th centuries. A maternally-descended line, the Komnenodoukai, founded the Despotate of Epirus in the 13th century, with another branch ruling over Thessaly.",
    },
    {
        id: "22",
    ...
    },
    {
        ...
        text: "The House of Angelos, was a Byzantine Greek noble family that produced several Emperors and other prominent nobles during the middle and late Byzantine Empire. The family rose to prominence through the marriage of its founder, Constantine Angelos, with Theodora Komnene, the youngest daughter of Emperor Alexios I Komnenos.",
    },
    {
        id: "24",
    ...
    },
    {
        ...
        text: "The House of Palaiologos, was a Byzantine Greek noble family that rose to power and produced the last and longest-ruling dynasty in the history of the Byzantine Empire. Their rule as Emperors and Autocrats of the Romans lasted almost two hundred years, from 1259 to the Fall of Constantinople in 1453.",
    },
]